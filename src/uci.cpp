...
void UCI::loop(int argc, char* argv[]) {
  ...
  do {
      ...
      else if (token == "export_net")
      {
          ...
          sync_cout << "\nColossal is a powerful chess engine for playing and analyzing."
                       "\nIt is released as free software licensed under the GNU GPLv3 License."
                       "\nColossal is normally used with a graphical user interface (GUI) and implements"
                       "\nthe Universal Chess Interface (UCI) protocol to communicate with a GUI, an API, etc."
                       "\nFor any further information, visit https://github.com/SirTech-1/Colossal#readme"
